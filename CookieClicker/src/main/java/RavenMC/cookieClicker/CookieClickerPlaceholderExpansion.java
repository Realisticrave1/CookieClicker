...
public class CookieClickerPlaceholderExpansion extends PlaceholderExpansion {
    ...
    public String onPlaceholderRequest(Player player, String identifier) {
        ...
        // %cookieclicker_bank_cookies% - Returns the player's bank cookie count
        if (identifier.equals("bank_cookies")) {
            return String.valueOf(playerData.getBankCookies());
        }

        // %cookieclicker_raven_coins% - Returns the player's raven coin count
        if (identifier.equals("raven_coins")) {
            return String.valueOf(playerData.getRavenCoins());
        }
